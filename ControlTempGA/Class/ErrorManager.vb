Public Class ErrorManager
    ...
    Public Shared Sub SetLogEvent(ByRef ex As Exception, ByRef Result As Object, ByRef Request As Object)
        ...
        SetLogEvent(ex)
    End Sub
    Public Shared Sub SendCorreoAdjunto(ByVal msj As String, direccionAdjunto As String, destinatarios As String, descripcionReporte As String, Oculto As Boolean)
