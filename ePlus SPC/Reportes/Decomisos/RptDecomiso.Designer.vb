...
Partial Class RptDecomiso
    ...
    Private Sub InitializeComponent()
        ...
        ReportDataSource1.Name = "DecomisoEncabezado"
        ReportDataSource2.Name = "DecomisoDetalle"
        ReportDataSource3.Name = "DecomisoDetalleRemiDesti"
        ReportDataSource4.Name = "ClassDetallePersonDeco"
        Me.WareHouse.LocalReport.DataSources.Add(ReportDataSource1)
        Me.WareHouse.LocalReport.DataSources.Add(ReportDataSource2)
        Me.WareHouse.LocalReport.DataSources.Add(ReportDataSource3)
        Me.WareHouse.LocalReport.DataSources.Add(ReportDataSource4)
        Me.WareHouse.LocalReport.ReportEmbeddedResource = "SPC.Decomiso.rdlc"
