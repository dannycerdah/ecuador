...
Imports System.IO
Public Class RptFotosElementosMalaCondicion
    ...
    Public elemento As String = String.Empty
    ...
    Private Sub RptWareHouse_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            StockElementos.LocalReport.DataSources.Add(New ReportDataSource("dtFoto", dtFotos))
            ...
            Me.StockElementos.LocalReport.EnableExternalImages = True
    ...
    Public Sub guardarReporte()
        Try
            ...
            If Not FileIO.FileSystem.DirectoryExists(rutaejecutable & "\Reports\ElementosCondicion") Then
                FileIO.FileSystem.CreateDirectory(rutaejecutable & "\Reports\ElementosCondicion")
            End If
            'If Not FileIO.FileSystem.DirectoryExists("\\192.168.10.1\instaladores\123456789\ElementosCondicion\") Then
            ...
            'path = "\\192.168.10.1\instaladores\123456789\ElementosCondicion\" & elemento & " " & DateTime.Now.ToString("dd-MM-yyyy") & ".pdf"
            path = rutaejecutable & "\Reports\ElementosCondicion" & elemento & " " & DateTime.Now.ToString("dd-MM-yyyy") & ".pdf"
