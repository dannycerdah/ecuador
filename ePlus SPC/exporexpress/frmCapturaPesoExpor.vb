...
Public Class frmCapturaPesoExpor
...
#End Region
    ...
    Private Sub frmCapturaPesoExpor_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmCapturaPesoExpor_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            With dtDetalleProcesoDev.Columns
                ...
                .Add("ancho", GetType(Integer))
                .Add("alto", GetType(Integer))
                .Add("tempCourier", GetType(Double))
                '.Add("tempA_3_4", GetType(Double))
                '.Add("tempB", GetType(Double))
                '.Add("tempC", GetType(Double))
                '.Add("tempZ_Flor", GetType(Double))
            ...
            With dtdetalleProcesoTemp.Columns
                ...
                .Add("ancho", GetType(Integer))
                .Add("alto", GetType(Integer))
                .Add("tempCourier", GetType(Integer))
                '.Add("tempA_3_4", GetType(Double))
                '.Add("tempB", GetType(Double))
                '.Add("tempC", GetType(Double))
                '.Add("tempZ_Flor", GetType(Double))
    ...
    Private Sub ObtenerProceso()
        ...
        Try
            ...
            For Each r As DataRow In dt.Rows
                ...
                nr.Item("tempCourier") = r.Item("tempA")
            ...
            If LsBandeAct = "S" Then 'JRO 01022018
                With myDetalleProceso
                    DetalleProceso = New Object() { .IdDetalleProceso, .fecha, .idGuia, .Guia, .dae, .idElemento, .agenciaTransporte, uceAgencia.Text,
                                                    ...
                                                    .estadoSenae, .tempA_3_4, .tempZ_Flor, .tempZ_Pq, .RegCargaCuartoFrio, .UsusarioIngreso}
                End With
            ...
            Else
                With myDetalleProceso
                    DetalleProceso = New Object() { .IdDetalleProceso, .fecha, .idGuia, .Guia, .dae, .idElemento, .agenciaTransporte,
                                                   ...
                                                   .tempA, .tempB, .tempC, .idCamion, .muelle, .indice, .tempA_3_4, .tempZ_Flor, .tempZ_Pq, .RegCargaCuartoFrio, .UsusarioIngreso}
                End With
                nr = dtDetalleProceso.NewRow
                nr.Item("idProceso") = DetalleProceso(0)
                nr.Item("fecha") = DetalleProceso(1)
        ...
        Try
            If RB_A2.Checked = True Then
                ...
                If res.ActionResult Then
                    ...
                    'inicio Jro 23092018 se comenta esta seccion de codigo para que no utilice recursos de la Pc abriendo y cerrando archivo 
                    'If txtEstadoDae.Text <> String.Empty Then
                    '    If txtEstadoDae.Text <> "DAE Incorrecto" Then
                    '        If Not IsNothing(dtGuias) Then
                    '            For Each r As DataRow In dtGuias.Rows
                    '                If (Not r.Item("enviadoSenae")) And (r.Item("idGuia") = myDetalleProceso.idGuia) Then
                    '                    'saveDocSenae(myDetalleProceso) 'EWLM pruebas
                    '                    EscribirLineaLog("S- " + myDetalleProceso.Guia.ToString + "; " + myDetalleProceso.dae.ToString + "; " + myDetalleProceso.hora.ToString + "; " + txtLector.Text, PathLog)
                    '                    Exit For
                    '                End If
                    '            Next
                    '        Else
                    ...
                    '    End If
                    'End If
                    'Fin Jro 23092018 se comenta esta seccion de codigo para que no utilice recursos de la Pc abriendo y cerrando archivo 
                Else
                    Throw New Exception(res.ErrorMessage)
                End If
            Else
    ...
    Private Sub chkA_CheckedChanged(sender As Object, e As EventArgs) Handles chkA2.CheckedChanged
        ...
        End If
    End Sub
    Private Sub chkB_CheckedChanged(sender As Object, e As EventArgs)
    ...
    Private Sub chkC_CheckedChanged(sender As Object, e As EventArgs)
        ...
        'End If
    End Sub
    Private Sub chkA34_CheckedChanged(sender As Object, e As EventArgs)
        ...
        'End If
    End Sub
    Private Sub chkZF_CheckedChanged(sender As Object, e As EventArgs)
        ...
        'End If
    End Sub
    Private Sub chkZp_CheckedChanged(sender As Object, e As EventArgs)
    ...
    Private Sub frmCapturaPesoExpor_MouseUp(sender As Object, e As MouseEventArgs) Handles MyBase.MouseUp
        ModuloCierre.InicioEjecucion = Date.Now
    End Sub

    Private Sub frmCapturaPesoExpor_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        ModuloCierre.InicioEjecucion = Date.Now
    End Sub

    Private Sub frmCapturaPesoExpor_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        ModuloCierre.InicioEjecucion = Date.Now
    End Sub

    Private Sub ugvCaptura_AfterCellActivate(sender As Object, e As EventArgs) Handles ugvCaptura.AfterCellActivate
