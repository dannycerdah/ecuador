...
Public Class frmReporteVuelos
    ...
    Private Sub btnConsVuelo_Click(sender As Object, e As EventArgs) Handles btnConsVuelo.Click
        Try
            ...
            If frmConsultaVuelos.Aerolinea <> "" Then
                ...
                idVuelo = frmConsultaVuelos.resDetVuelo.idVuelo
                CargarRptBriefing()
                ...
                If Not IsNothing(myNovedades) Then
                    ...
                    Catch ex As Exception
                        MessageBox.Show("No olvidar ingresar las horas de llegada y salida del avion y dar GUARDAR", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        udtLlegadaAvion.Value = udtEta.Value
                        udtSalidaAvion.Value = DateAdd(DateInterval.Minute, 15, udtEtd.Value)
                        udtSubeCargaDesde.Value = cargaHoraInicio
                        udtSubeCargaHasta.Value = cargaHoraFin
                    End Try
                End If
    ...
    '            tempGuiaCamion.fecha = r.Item("fecha")
    ...
    Private Sub consultaProceso()
        ...
        Try
            ...
            GetDetalleProcesoPorIdProcesoReporteAsync() 'dtDetalleProcesoReporte = CommonProcess.GetDetalleProcesoPorIdProcesoReporteAsync(myProceso.IdProceso).Result
            GetDetalleProcesoCargaPorIdProcesoReporteAsync() 'dtDetalleProcesoCargaReporte = CommonProcess.GetDetalleProcesoCargaPorIdProcesoReporteAsync(myProceso.IdProceso).Result
            GetDetalleProcesoPorIdProcesoCargaIAsync() 'dtDetalleProcesoCargaReporteCargaI = CommonProcess.GetDetalleProcesoPorIdProcesoCargaIAsync(myProceso.IdProceso).Result
            GetDetalleProcesoPorIdProcesoCargaRAsync() ' dtDetalleProcesoCargaReporteCargaR = CommonProcess.GetDetalleProcesoPorIdProcesoCargaRAsync(myProceso.IdProceso).Result
            GetDetalleProcesoCargaPorIdProcesoAlmacenajeAsync() ' dtDetalleProcesoCargaAlmacenaje = CommonProcess.GetDetalleProcesoCargaPorIdProcesoAlmacenajeAsync(myProceso.IdProceso).Result
            GetElementoProcesoPorIdProcesoAsync() 'dtComparacionPeso = CommonProcess.GetElementoProcesoPorIdProcesoAsync(myProceso.IdProceso).Result
            GetReportePorIdProcesoGroupByElemento2Async() ' dtDetalleProcesoCargaElementosCargados = CommonProcess.GetReportePorIdProcesoGroupByElemento2Async(myProceso.IdProceso).Result
            GetDetalleAcarreoIdProcesoReporteAsync() ' dtDetalleAcarreoReporte = CommonProcess.GetDetalleAcarreoIdProcesoReporteAsync(myProceso.IdProceso).Result
            GetDetallePersonalPorIdProcesoReporteAsync()
        Catch ex As Exception
            General.SetLogEvent(ex)
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Async Sub GetDetalleProcesoPorIdProcesoReporteAsync()
        dtDetalleProcesoReporte = Await CommonProcess.GetDetalleProcesoPorIdProcesoReporteAsync(myProceso.IdProceso)
    End Sub
    Private Async Sub GetDetalleProcesoCargaPorIdProcesoReporteAsync()
        dtDetalleProcesoCargaReporte = Await CommonProcess.GetDetalleProcesoCargaPorIdProcesoReporteAsync(myProceso.IdProceso)
    End Sub
    Private Async Sub GetDetalleProcesoPorIdProcesoCargaIAsync()
        dtDetalleProcesoCargaReporteCargaI = Await CommonProcess.GetDetalleProcesoPorIdProcesoCargaIAsync(myProceso.IdProceso)
    End Sub
    Private Async Sub GetDetalleProcesoPorIdProcesoCargaRAsync()
        dtDetalleProcesoCargaReporteCargaR = Await CommonProcess.GetDetalleProcesoPorIdProcesoCargaRAsync(myProceso.IdProceso)
    End Sub
    Private Async Sub GetDetalleProcesoCargaPorIdProcesoAlmacenajeAsync()
        dtDetalleProcesoCargaAlmacenaje = Await CommonProcess.GetDetalleProcesoCargaPorIdProcesoAlmacenajeAsync(myProceso.IdProceso)
    End Sub
    Private Async Sub GetElementoProcesoPorIdProcesoAsync()
        dtComparacionPeso = Await CommonProcess.GetElementoProcesoPorIdProcesoAsync(myProceso.IdProceso)
    End Sub
    Private Async Sub GetReportePorIdProcesoGroupByElemento2Async()
        dtDetalleProcesoCargaElementosCargados = Await CommonProcess.GetReportePorIdProcesoGroupByElemento2Async(myProceso.IdProceso)
    End Sub
    Private Async Sub GetDetallePersonalPorIdProcesoReporteAsync()
        dtDetallePersonalProcesoReporte = Await CommonProcess.GetDetallePersonalPorIdProcesoReporteAsync(myProceso.IdProceso)
    End Sub
    Private Async Sub GetDetalleAcarreoIdProcesoReporteAsync()
        dtDetalleAcarreoReporte = Await CommonProcess.GetDetalleAcarreoIdProcesoReporteAsync(myProceso.IdProceso)
    End Sub
    ...
    Private Sub SetDisplayColumnsCamiones()
        Try
            ugvCamiones.DisplayLayout.Bands(0).Columns("idGuia").Hidden = True
            ugvCamiones.DisplayLayout.Bands(0).Columns("descripcion").Header.Caption = "Guia"
            ugvCamiones.DisplayLayout.Bands(0).Columns("idAgencia").Hidden = True
            ugvCamiones.DisplayLayout.Bands(0).Columns("descripcionAgencia").Header.Caption = "Agencia de Carga"
            ugvCamiones.DisplayLayout.Bands(0).Columns("idCamion").Hidden = True
            ugvCamiones.DisplayLayout.Bands(0).Columns("matriculaCamion").Header.Caption = "Matricula Camión"
            ugvCamiones.DisplayLayout.Bands(0).Columns("fecha").Header.Caption = "Fecha de Llegada"
            ugvCamiones.DisplayLayout.Bands(0).Columns("fecha").Format = "dd/MM/yyyy H:mm:ss"
            ugvCamiones.DisplayLayout.Bands(0).Columns("fecha").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
            ugvCamiones.DisplayLayout.Bands(0).Columns("idContacto").Header.Caption = "Id. Chofer"
            ugvCamiones.DisplayLayout.Bands(0).Columns("primerApellidoContacto").Header.Caption = "Apellido Chofer"
            ugvCamiones.DisplayLayout.Bands(0).Columns("primerNombreContacto").Header.Caption = "Nombre Chofer"
            ugvCamiones.DisplayLayout.Bands(0).Columns("procedencia").Header.Caption = "Procedencia Camión"
    ...
    Private Sub SetDisplayColumnsDollys()
        Try
            ...
            ugvDollys.DisplayLayout.Bands(0).Columns("idChofer").Header.Caption = "Id. Chofer"
            ugvDollys.DisplayLayout.Bands(0).Columns("chofer").Header.Caption = "Nombre/s Chofer"
            ...
            ugvDollys.DisplayLayout.Bands(0).Columns("idCustodio").Header.Caption = "Id. Custodio"
            ugvDollys.DisplayLayout.Bands(0).Columns("custodio").Header.Caption = "Nombre/s Custodio"
            ...
            ugvDollys.DisplayLayout.Bands(0).Columns("fechaEntrada").Header.Caption = "Fecha de Ingreso"
            ...
            ugvDollys.DisplayLayout.Bands(0).Columns("fechaSalida").Header.Caption = "Fecha de Salida"
    ...
    Private Sub ugvDollys_DoubleClickRow(sender As Object, e As Infragistics.Win.UltraWinGrid.DoubleClickRowEventArgs) Handles ugvDollys.DoubleClickRow
        Try
            Dim idDetalle As New Guid
            If Not ugvDollys.ActiveRow.Cells("idDetalle").Value.ToString = String.Empty Then
                idDetalle = ugvDollys.ActiveRow.Cells("idDetalle").Value
                ShowDetalleReporteVueloDollys(idDetalle)
            End If
        Catch ex As Exception
            General.SetLogEvent(ex)
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub ShowDetalleReporteVueloDollys(idDetalle As Guid)
        Using frmDetails As New frmDetalleReporteVueloDollys(idDetalle)
            frmDetails.ShowDialog()
        End Using
    End Sub

    Private Sub SetDisplayColumnsPersonal()
        Try
            ugvProceso.DisplayLayout.Bands(0).Columns("idProceso").Hidden = True
            ugvProceso.DisplayLayout.Bands(0).Columns("idMatrizSeg").Hidden = True
            ugvProceso.DisplayLayout.Bands(0).Columns("idAgencia").Hidden = True
            ugvProceso.DisplayLayout.Bands(0).Columns("idTipo").Hidden = True
            ugvProceso.DisplayLayout.Bands(0).Columns("descripcionTipo").Hidden = True
            ugvProceso.DisplayLayout.Bands(0).Columns("descripcionAgencia").Header.Caption = "Actividad"
            ugvProceso.DisplayLayout.Bands(0).Columns("cargo").Header.Caption = "Cargo"
            ugvProceso.DisplayLayout.Bands(0).Columns("primerApellidoContacto").Header.Caption = "Apellido"
            ugvProceso.DisplayLayout.Bands(0).Columns("primerNombreContacto").Header.Caption = "Nombre"
            ugvProceso.DisplayLayout.Bands(0).Columns("horaInicio").Header.Caption = "Fecha de Ingreso"
            ugvProceso.DisplayLayout.Bands(0).Columns("horaInicio").Format = "dd/MM/yyyy H:mm:ss"
            ugvProceso.DisplayLayout.Bands(0).Columns("horaInicio").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
            ugvProceso.DisplayLayout.Bands(0).Columns("horaFin").Header.Caption = "Fecha de Salida"
            ugvProceso.DisplayLayout.Bands(0).Columns("horaFin").Format = "dd/MM/yyyy H:mm:ss"
            ugvProceso.DisplayLayout.Bands(0).Columns("horaFin").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
        Catch ex As Exception
            General.SetLogEvent(ex)
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub CargarRptElementosPresel()
        ...
        Try
            ...
            For Each r As DataRow In CommonProcess.GetElementoBriefingPorIdBriefing(elementoBriefing).Rows
                ...
                For Each rows As DataRow In dtComparacionPeso.Rows
                    If rows.Item("idElemento") = elementoPreselDetalle.idElemento Then
                        elementoPreselDetalle.red = rows.Item("red")
                        Exit For
                    End If
                Next
        ...
        Try
            ...
            For Each r As DataRow In dtDetalleProcesoCargaReporte.Rows
                ...
                If (r.Item("estado") = "A" Or r.Item("estado") = "I" Or r.Item("estado") = "D") Then
                    ...
                    'If ProcesoCargaDetalle2.M = "03" Or ProcesoCargaDetalle2.M = "04" Then
                    '    ProcesoCargaDetalle2.CuartoFrio = "A3-4"
                    'ElseIf ProcesoCargaDetalle2.M = "02" Then
                    '    ProcesoCargaDetalle2.CuartoFrio = "A2"
                    'Else
                    '    ProcesoCargaDetalle2.CuartoFrio = "N/D"
                    'End If
    ...
    Private Sub CargarRptProcesoAlmacenaje()
        Try
            ...
            For Each r As DataRow In dtDetalleProcesoCargaAlmacenaje.Rows
                ...
                'muelle = r.Item("muelle").ToString.Substring(0, 8).Remove(0, 6) 'MARZ 
                'If muelle = "03" Or muelle = "04" Then
                '    ProcesoCargaAlmacenajeDetalle.Muelle = "Temp" & "A3-4"
                '    ProcesoCargaAlmacenajeDetalle.TempMuelle = r.Item("tempA_3_4")
                'ElseIf muelle = "02" Then
                '    ProcesoCargaAlmacenajeDetalle.Muelle = "Temp" & "A2"
                '    ProcesoCargaAlmacenajeDetalle.TempMuelle = r.Item("tempA")
                'Else
                '    ProcesoCargaAlmacenajeDetalle.Muelle = "N/D"
                '    ProcesoCargaAlmacenajeDetalle.TempMuelle = 0
                'End If
                ...
                For Each r2 As DataRow In dtComparacionPeso.Rows
                    If r.Item("idElemento") = r2.Item("idElemento") And r2.Item("estado") = "A" Then
                        ...
                        ProcesoCargaAlmacenajeDetalle.red = r2.Item("red")
    ...
    Private Sub CargarRptDetalleAcarreo()
        Try
            ...
            For Each o In Acarreo.detalleAcarreo
                ...
                o.PesoGross = 0
                For Each r2 As DataRow In dtComparacionPeso.Rows
                    If o.elemento = r2.Item("idElemento") And r2.Item("estado") = "A" Then
                        o.pesoUDL += r2.Item("pesoEntradaElemento") 'peso elemento
                        o.pesoMalla += r2.Item("red") 'malla
                        'ProcesoCargaAlmacenajeDetalle.cpPesoTotal = r2.Item("pesoCaptura") + r2.Item("pesoEntradaElemento") 'gross
                    End If
                Next
            Next
    ...
    Private Sub btnEnviar_Click(sender As Object, e As EventArgs) Handles btnEnviar.Click
        Try
            ...
            Dim EnviarVuelo As Boolean = True
            ...
            If ClassReportVueloEnvi.Result = True And ClassReportVueloEnvi.Total = 0 Then
                EnviarVuelo = True
            Else
                If MessageBox.Show("¿Desa Volver a Enviar el Vuelo?", "Confirmar Envio de Vuelo", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
                    EnviarVuelo = True
                Else
                    EnviarVuelo = False
                End If
            End If
            If EnviarVuelo Then
                If txtNumVuelo.Text.Trim.Length < 4 Then
                    MessageBox.Show("ERROR VUELO NO INGRESADO, NO SE HAN ENVIADO  CORREOS, OBLIGATORIO CORREGIR VUELO. Y VUELVA A ENVIAR", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
                'CargarRptBriefing()
                CargarRptElementosPresel() 'error verificar
                CargarRptCamiones()
                CargarRptPersonalProceso()
                'CargarRptProcesoCarga()
                CargarRptProcesoAlmacenaje()
    ...
    Private Sub SetDisplayColumnsChequeo()
        Try
            ugvChequeo.DisplayLayout.Bands(0).Columns("idGuia").Hidden = True
            ugvChequeo.DisplayLayout.Bands(0).Columns("guia").Header.Caption = "Guia"
            ugvChequeo.DisplayLayout.Bands(0).Columns("piezas").Header.Caption = "Piezas"
            ugvChequeo.DisplayLayout.Bands(0).Columns("peso").Header.Caption = "Peso"
            ugvChequeo.DisplayLayout.Bands(0).Columns("man").Header.Caption = "Chequeo"
        Catch ex As Exception
            General.SetLogEvent(ex)
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub CargarRptDetalleAcarreoStack()
        ' Throw New NotImplementedException
    End Sub

    Private Sub frmReporteVuelos_MouseMove(sender As Object, e As MouseEventArgs) Handles MyBase.MouseMove
        ModuloCierre.InicioEjecucion = Date.Now
    End Sub

    Private Sub frmReporteVuelos_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        ModuloCierre.InicioEjecucion = Date.Now
    End Sub

    Private Sub frmReporteVuelos_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
